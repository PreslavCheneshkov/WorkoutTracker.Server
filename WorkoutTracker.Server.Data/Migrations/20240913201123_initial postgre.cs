        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentBodyfatPercentage = table.Column<double>(type: "double precision", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    WorkoutTrackerUserId = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TrainingSessions_AspNetUsers_WorkoutTrackerUserId",
                        column: x => x.WorkoutTrackerUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ExerciseParameterNameId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExerciseParameters", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExerciseParameters_ExerciseParameterNames_ExerciseParameter~",
                        column: x => x.ExerciseParameterNameId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExerciseParameters_ExerciseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrainingSessions_WorkoutTrackerUserId",
